...
- (void)viewDidLoad {
    ...
    segmentedControl1.backgroundColorFrameWidthType = HMSegmentedControlBackgroundColorFrameWidthSegmentsWidth;
    segmentedControl1.backgroundColor = [UIColor lightGrayColor];
    segmentedControl1.segmentWidthStyle = HMSegmentedControlSegmentWidthStyleCustomWidth;
    segmentedControl1.customSegmentWidth = 40.f;
